...
from LeptonJetGeneration.Dimuon.HiggsPortal_cfi import *
process.HiggsPortal=dimuon.clone()
process.HiggsPortal.debug=3
...
process.p = cms.Path(process.HiggsPortal)
