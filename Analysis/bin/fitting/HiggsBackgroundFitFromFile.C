...
void HiggsBackgroundFitFromFile()
{
	...
	std::map<std::string, std::vector<std::string>> fileMap =
	{
		...
		{"TTbar Background", {"ST_s-channel", "ST_t-channel_antitop", "ST_t-channel_top", "ST_tW_antitop", "ST_tW_top", "TTTo2L2Nu", "TTToHadronic", "TTToSemiLeptonic", "ttHJetToNonbb", "ttHTo2L2Nu", "ttHToEE", "ttHToTauTau", "ttWJets", "ttZJets"}},
		{"Other Background", {"GluGluZH", "HZJ_HToWWTo2L2Nu_ZTo2L", "TWZToLL", "WGToLNuG", "WJetsToLNu_0J", "WJetsToLNu_2J", "WJetsToLNu_2J", "WJetsToLNu_HT-100To200", "WJetsToLNu_HT-200To400", "WJetsToLNu_HT-400To600", "WJetsToLNu_HT-600To800", "WJetsToLNu_HT-70To100", "WJetsToLNu_HT-800To1200", "WJetsToLNu_NLO", "WWTo2L2Nu", "WWW", "WWZ", "WW", "WZTo2Q2L", "WZTo3LNu", "WZZ", "WZ", "ZHToMuMu", "ZHToTauTau", "ZZZ"}}
	...
	for (const auto& histType : histogramTypes) 
	{
		for (const auto& channel : channelTypes)
		{
			...
			for (auto fileList : fileMap)
			{
				...
				std::string rangeKey = histType + "_" + channel;
				auto range = histRanges[rangeKey][background];
