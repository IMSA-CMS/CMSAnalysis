...
void SuperPlot()
{
	...
	std::shared_ptr<Channel> leptonBackgrounds = higgsAnalysis->getChannel("Muon1700");
	...
	//TCanvas *canvas = plotFormatter->superImposedHist(leptonBackgrounds, HistVariable::MET, true, xAxisTitle, yAxisTitle);
