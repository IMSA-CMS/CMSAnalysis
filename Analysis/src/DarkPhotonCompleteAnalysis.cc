...
DarkPhotonCompleteAnalysis::DarkPhotonCompleteAnalysis() {
    ...
    //for (std::string recoDecay : recoDecays){
      //  for(double massTarget : massTargets) {
            ...
            zzBackground->addProcess(makeSignalProcess(histVariablesBackground, filePath, "ZZ_Decay_4e_Run_2.root", "ZZTo4e", reader, massTarget, luminosity));
...
std::shared_ptr<Channel> DarkPhotonCompleteAnalysis::getChannel(std::string name)
{
