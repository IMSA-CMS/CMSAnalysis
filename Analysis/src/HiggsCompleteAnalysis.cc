...
HiggsCompleteAnalysis::HiggsCompleteAnalysis() {
    ...
    for(std::string name : names) {
        for(double massTarget : massTargets) {
            ...
            //Add your hists here
            histVariables.push_back(HistVariable::InvariantMass(name + "__hists/" + name + "_Muon" + " Opposite Sign Invariant Mass"));
            ...
            ttbarBackground->addProcess(makeSignalProcess(histVariables, filePath, "TTbartoLL.root", "ttbar_lep50to500", reader, massTarget, luminosity));
            ...
            multiBosonBackground->addProcess(makeSignalProcess(histVariables, filePath, "MultiBoson_WWto2L.root", "ww2l2nu", reader, massTarget, luminosity));
