...
// 	        newHiggs->addProcess(makeBasicProcess(newHiggsHistVariables, newFilePath, "run2Higgs" + std::to_string((int) massTarget) + "GenSim.root", "higgs4l" + std::to_string((int) massTarget), reader, massTarget, luminosity));
//             auto higgsSignal = std::make_shared<Process>("Old Higgs", 2);
//             higgsSignal->addProcess(makeBasicProcess(newHiggsHistVariables, newFilePath, "delphesHiggs" + std::to_string((int) massTarget) + "GenSim.root", "higgs4l" + std::to_string((int) massTarget), reader, massTarget, luminosity));
...
// TH1* HiggsGenComparisonAnalysis::getHist(std::string histType, std::string processName, double massTarget, bool scaleToExpected, std::string channelName) const {
//     int maxBinNum = 0;
