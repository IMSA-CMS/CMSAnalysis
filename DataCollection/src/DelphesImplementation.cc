...
DelphesImplementation::DelphesImplementation(reco::Candidate::LorentzVector vec, int ch, Particle::Type type,int pid, int status, int m1, int m2,int d1, int d2, double iIsolation ):
lorentzVec(vec), 
particleCharge(ch),
particleType(type),
