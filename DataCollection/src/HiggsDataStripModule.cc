...
void HiggsDataStripModule::initialize()
{
	...
	{
		treeId->Branch("pt1", &pt1, "pt1/F");
		treeId->Branch("pt2", &pt2, "pt2/F");
		treeId->Branch("phi1", &phi1, "phi1/F");
		treeId->Branch("phi2", &phi2, "phi2/F");
		treeId->Branch("eta1", &eta1, "eta1/F");
		treeId->Branch("eta2", &eta2, "eta2/F");
