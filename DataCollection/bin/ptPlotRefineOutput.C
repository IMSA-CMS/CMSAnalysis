...
void ptPlotRefineOutput()
{
  ...
  TFile* LR = TFile::Open("LR.root");
  TFile* RL = TFile::Open("RL.root");
  ...
  plotTwoPlots("GenSim Transverse Momentum Pasted;1", "GenSim Transverse Momentum Pasted;1", "GenSim Transverse Momentum Distribution for LR vs. RL", LR, RL, "Transverse Momentum", "Number of Events", "LRGenSimMuons", "RLGenSimMuons");
...
void plotTwoPlots(string hist1, string hist2, string canvasName, TFile* file1, TFile* file2, string xaxis, string yaxis, string legend1, string legend2, double legendLeftSide)
{
  ...
  c1->SetLogy(true);
  const char* canvasTitle = "GenSim Transverse Momentum Distribution for LR vs. RL";
