...
stdout = Popen('dasgoclient -query="dataset dataset=/QCD_HT*CP5*/*/NANOAOD"', shell=True, stdout=PIPE).stdout
output = stdout.read()
...
for dataset in datasets:
    ...
    if (name == "Data_Trigger_SingleElectron_Year_2018A"):
        ...
        req = 'dasgoclient --query="file dataset=' + dataset + '" > textfiles/PlainQCD/' + name
        print("Making " + name + "\n")
        os.system(req)
