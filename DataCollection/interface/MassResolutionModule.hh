...
{
public:
  MassResolutionModule(const std::shared_ptr<WeightingModule> weightingModule, const std::shared_ptr<LRWeightModule> lrWeightModule, const std::shared_ptr<MatchingModule> matchingModule, std::string bin = "mass", const int minMass = 300, const int maxMass = 3200, const int massIntervalSize = 100);
