...
//   const edm::TriggerResults &triggerResults = getInput()->getTriggerResults(subProcess);
    
//   const edm::TriggerNames &triggerNames = getInput()->getTriggerNames(subProcess);
...
//       if (triggerResultsData.find(triggerNames.triggerName(i)) == triggerResultsData.end())
//       {
//         // if not in there, add a log to the map, make value 1 if it passed
//         triggerResultsData.insert({triggerNames.triggerName(i), {(int)passCurrentTrigger, 1}}); 
//       }
//       else
//       {
...
//       if (passCurrentTrigger)
//       {
//         passedTriggers.push_back(triggerNames.triggerName(i));
//       }
//     }
//   }
