...
class ReadCutsD : public IClassifierReader {
 ...
 public:
        ...
        fIsNormalised( false )
   {
      ...
      fVmin[0] = 3.11988043785095;
      fVmax[0] = 14.1177463531494;
      fVmin[1] = 0.00904925540089607;
      fVmax[1] = 5.81612586975098;
...
inline void ReadCutsD::InitTransform_1()
{
   ...
   fDecTF_1[0][0][0] = 7.36087210047;
   fDecTF_1[0][0][1] = 6.32258493206e-05;
   fDecTF_1[0][1][0] = 6.32258493206e-05;
   fDecTF_1[0][1][1] = 0.00134362131884;
   fDecTF_1[1][0][0] = 1.15062990645;
   fDecTF_1[1][0][1] = -0.000923838444236;
   fDecTF_1[1][1][0] = -0.000923838444236;
   fDecTF_1[1][1][1] = 0.00508256744016;
   fDecTF_1[2][0][0] = 1.55928870506;
   fDecTF_1[2][0][1] = 0.000175625479553;
   fDecTF_1[2][1][0] = 0.000175625479553;
   fDecTF_1[2][1][1] = 0.001172372247;
}
