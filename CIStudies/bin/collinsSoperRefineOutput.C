...
void plotTwoPlots(string hist1, string hist2, string canvasName, TFile* file, string xaxis, string yaxis, string legend1, string legend2, double legendLeftSide = .4);

void collinsSoperRefineOutput()
{
  
  TFile* genOutput = TFile::Open("genOutput.backup.root");
  ...
  TFile* outputPercentDiff = TFile::Open("refinedOutputCollinsSoper.root", "recreate");

  plotTwoPlots("histCollinsSoper", "histIncorrectCollinsSoper", "Collins-Soper Angle", genOutput, "cos #theta",
...
void plotTwoPlots(string hist1, string hist2, string canvasName, TFile* file, string xaxis, string yaxis, string legend1, string legend2, double legendLeftSide)
{
  TCanvas* c1 = new TCanvas(canvasName.c_str(), canvasName.c_str());

  auto plot1 = getHist(hist1.c_str(), file);
  auto plot2 = getHist(hist2.c_str(), file);
