...
class Particle
{
  public: 
    ...
    Particle(reco::Candidate::LorentzVector vec, double dxy, double dz, int pid, Particle::SelectionFit fit = Particle::SelectionFit::Tight);
    Particle(reco::Candidate::LorentzVector vec, double dxy, double dz, int charge, const ParticleType& type, Particle::SelectionFit fit = Particle::SelectionFit::Tight);
