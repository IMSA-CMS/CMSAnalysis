...
class ParticleType
{
  public:
    ...
    ParticleType();
    ParticleType(std::string typeName, int typepdgId, double charge, std::vector<HistParams> typeParticleHists,
                 std::vector<CollectionHistParams>
                     typeCollectionHists); // std::vector<CollectionHistParams> CollectionHistParamss);
  ...
  private:
    ...
    static const ParticleType &registerType(std::string typeName, int typepdgId, double charge,
